...
export class ControlCenter {
  ...
  createContol() {
    ...
    this.control.bubbleIcon.on('pointerdown', () => {
      ...
      this.control.bubbleIcon.setTint(Color.PUSH);
    });

    this.control.bubbleIcon.on('pointerup', () => {
      setTimeout(() => {
        this.control.bubbleIcon.clearTint();
      }, 200);
    });
    ...
    this.control.cleanIcon.on('pointerdown', () => {
      ...
      this.control.cleanIcon.setTint(Color.PUSH);
    });

    this.control.cleanIcon.on('pointerup', () => {
      setTimeout(() => {
        this.control.cleanIcon.clearTint();
      }, 200);
    });
    ...
    this.control.doorIcon.on('pointerdown', () => {
      ...
      this.control.doorIcon.setTint(Color.PUSH);
    });

    this.control.doorIcon.on('pointerup', () => {
      setTimeout(() => {
        this.control.doorIcon.clearTint();
      }, 200);
    });
